...
/// the user about the app's privacy on the app's first launch.
///
/// The [onConfirm] defaults to navigate back, once the 'confirm' button is
/// pressed.
class PrivacyDisclaimerScreen extends StatefulWidget {
  /// Creates a [PrivacyDisclaimerScreen].
  const PrivacyDisclaimerScreen({
    Key? key,
    this.onConfirm,
  }) : super(key: key);
  ...
  @override
  _PrivacyDisclaimerScreenState createState() =>
      _PrivacyDisclaimerScreenState();
}

class _PrivacyDisclaimerScreenState extends State<PrivacyDisclaimerScreen> {
